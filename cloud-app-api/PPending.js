...
//This Lambda function is to retrieve all pending projects 
export async function main(event, context) {
    const params = {
        ...
        ExpressionAttributeValues: { ":v": "Pending" }//ExpressionAttributeValue defines the Attribute value scanned  
    }; try {
